...
export const ColorHighlightPopoverButton = forwardRef(({ className, children, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      role="button"
      tabIndex={-1}
      aria-label={t("toolbar.highlightText")}
...
export function ColorHighlightPopoverContent({
  ...
  const menuItems = useMemo(() => [...colors, { labelKey: "toolbar.removeHighlight", value: "none" }], [colors])
        ...
        <CardItemGroup orientation="horizontal">
          ...
          <ButtonGroup orientation="horizontal">
            <Button
              ...
              aria-label={t("toolbar.removeHighlight")}
              tooltip={t("toolbar.removeHighlight")}
...
export function ColorHighlightPopover({
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent aria-label={t("toolbar.highlightColors")}>
