...
export const HIGHLIGHT_COLORS = [
  ...
  {
    labelKey: "colors.gray",
    value: "var(--tt-color-highlight-gray)",
    colorValue: "#f8f8f7",
    border: "var(--tt-color-highlight-gray-contrast)",
  },
  {
    labelKey: "colors.brown",
    value: "var(--tt-color-highlight-brown)",
    colorValue: "#f4eeee",
    border: "var(--tt-color-highlight-brown-contrast)",
  },
  {
    labelKey: "colors.orange",
    value: "var(--tt-color-highlight-orange)",
    colorValue: "#fbecdd",
    border: "var(--tt-color-highlight-orange-contrast)",
  },
  {
    labelKey: "colors.yellow",
    value: "var(--tt-color-highlight-yellow)",
    colorValue: "#fef9c3",
    border: "var(--tt-color-highlight-yellow-contrast)",
  },
  {
    labelKey: "colors.green",
  ...
  {
    labelKey: "colors.purple",
    value: "var(--tt-color-highlight-purple)",
    colorValue: "#f3e8ff",
    border: "var(--tt-color-highlight-purple-contrast)",
  },
  {
    labelKey: "colors.pink",
...
export function useColorHighlight(config) {
  ...
  const handleRemoveHighlight = useCallback(() => {
    ...
    if (success) {
      onApplied?.({ color: "", label: t("toolbar.removeHighlight"), mode })
    }
    return success
  ...
  return {
    ...
    label: label || t("toolbar.highlight"),
